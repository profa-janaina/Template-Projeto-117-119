...
quickDrawDatasetPT=["porta-avioes","aviao","despertador","ambulancia","anjo","migracao animal","formiga","bigorna","maca","braco","aspargos",
...
// Escreva o código AULA 117


//---------------------------------------------------------------------------------

document.getElementById('sketchName').innerHTML = 'Esboço a ser desenhado: ' + desenho;
...
function updateCanvas() {
  ...
  desenho = quickDrawDatasetPT[randomNumber];
  document.getElementById('sketchName').innerHTML = 'Esboço a ser desenhado: ' + desenho;
}
